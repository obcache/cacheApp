...
GuiOperationsTab(&ui,&cfg,&afk) { ;libGuiOperationsTab
	...
	{ ;GameWindows Gui Controls
		...
		ui.OpsAfkButton := ui.MainGui.AddPicture("ys+0 x+1 w47 h48 section Background" cfg.ThemeButtonReadyColor,"./img2/button_afk_ready.png")
		...
		ui.Win1EnabledToggle.ToolTip := "Toggle to have this window ignored by cacheApp"

		ui.Win2EnabledToggle.OnEvent("Click",ToggleGame2Status)
		ui.Win2EnabledToggle.ToolTip := "Toggle to have this window ignored by cacheApp"
...
ShowHelp() {
	...
	ui.HelpGui.Title := "Help for cacheApp " A_FileVersion
