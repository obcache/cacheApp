		...
		if StrCompare(A_ScriptDir,InstallDir)
  		{
			...
			fileInstall("./img2/infogfx/vod/activate.png", "/img2/infogfx/vod/activate.png",1)
			fileInstall("./img2/infogfx/vod/ascendant.png", "/img2/infogfx/vod/ascendant.png",1)
			fileInstall("./img2/infogfx/vod/black_garden.png", "/img2/infogfx/vod/black_garden.png",1)
			fileInstall("./img2/infogfx/vod/black_heart.png", "/img2/infogfx/vod/black_heart.png",1)
			fileInstall("./img2/infogfx/vod/darkness.png", "/img2/infogfx/vod/darkness.png",1)
			fileInstall("./img2/infogfx/vod/drink.png", "/img2/infogfx/vod/drink.png",1)
			fileInstall("./img2/infogfx/vod/earth.png", "/img2/infogfx/vod/earth.png",1)
			fileInstall("./img2/infogfx/vod/enter.png", "/img2/infogfx/vod/enter.png",1)
			fileInstall("./img2/infogfx/vod/grieve.png", "/img2/infogfx/vod/grieve.png",1)
			fileInstall("./img2/infogfx/vod/guardian.png", "/img2/infogfx/vod/guardian.png",1)
			fileInstall("./img2/infogfx/vod/hive.png", "/img2/infogfx/vod/hive.png",1)
			fileInstall("./img2/infogfx/vod/kill.png", "/img2/infogfx/vod/kill.png",1)
			fileInstall("./img2/infogfx/vod/light.png", "/img2/infogfx/vod/light.png",1)
			fileInstall("./img2/infogfx/vod/love.png", "/img2/infogfx/vod/love.png",1)
			fileInstall("./img2/infogfx/vod/pyramid.png", "/img2/infogfx/vod/pyramid.png",1)
			fileInstall("./img2/infogfx/vod/redacted.png", "/img2/infogfx/vod/redacted.png",1)
			fileInstall("./img2/infogfx/vod/remember.png", "/img2/infogfx/vod/remember.png",1)
			fileInstall("./img2/infogfx/vod/savathun.png", "/img2/infogfx/vod/savathun.png",1)
			fileInstall("./img2/infogfx/vod/scorn.png", "/img2/infogfx/vod/scorn.png",1)
			fileInstall("./img2/infogfx/vod/stop.png", "/img2/infogfx/vod/stop.png",1)
			fileInstall("./img2/infogfx/vod/tower.png", "/img2/infogfx/vod/tower.png",1)
			fileInstall("./img2/infogfx/vod/traveler.png", "/img2/infogfx/vod/traveler.png",1)
			fileInstall("./img2/infogfx/vod/witness.png", "/img2/infogfx/vod/witness.png",1)
			fileInstall("./img2/infogfx/vod/worm.png", "/img2/infogfx/vod/worm.png",1)
			fileInstall("./img2/infogfx/vod/worship.png", "/img2/infogfx/vod/worship.png",1)
			fileInstall("./img2/tab_selected.png","/img2/tab_selected.png",1)
			fileInstall("./img2/tab_unselected.png","/img2/tab_unselected.png",1)
